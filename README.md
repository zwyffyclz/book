...
This repository contains the source code for the **INFO 448: Android Development** lecture notes. The published book can be viewed at **https://info448.github.io/**.
...
- **`make deploy`** to publish the built book to `https://info448.github.io`.
