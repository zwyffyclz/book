...
Request myRequest = new StringRequest(Request.Method.GET, urlString,
...
To do this, you will want to create an entire class (e.g., `RequestSingleton`) that will control access to a single instance of the Volley `RequestQueue`:
