...
<p class="alert alert-warning">Note that the intial version of this program accesses the device's User Dictionary, which is only available to on API 22 (Lollipop) _or earlier_. The tutorial does support all versions of Android.</p>
