...
- It is possible to create your own Content Providers (described in the next chapter), but this lecture focuses purely on _utilizing_ existing Providers.
...
That covers how to utilize and interact with a Content Provider (as a _client_ of that Provider). The next lecture will cover how to implement a Provider for a custom database.
